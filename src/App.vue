...
<template>
  <div class="wrapper">
    <div class="topBar w-full lg:hidden fixed top-0">
      <div class="hamburger hamburger--slider" ref="hamburger" @click.prevent.stop="toggleMenuMob">
    ...
    <div class="w-full flex flex-row flex-nowrap">
      ...
      <div class="pt-17 lg:pt-0 flex-grow-0 h-screen w-full">
